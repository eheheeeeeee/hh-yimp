...
printf("into heavyhash_hash 3\n");    
    generate_matrix(matrix, &state);

printf("into heavyhash_hash 3\n");

    heavyhash(matrix, (void*)input, 80, output);
printf("into heavyhash_hash 4\n");
}
/*
void heavyhash_hash(const char* input, char* output, uint32_t len)
{
    // calling original heavyhash_hash
    compute_blockheader_heavyhash(input,output);
}
*/
