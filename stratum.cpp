...
static void scrypt1048576_hash(const char* input, char* output, uint32_t len)
{
	scrypt_1048576_1_1_256((unsigned char *)input, (unsigned char *)output);
}
...
YAAMP_ALGO g_algos[] =
{
	...
	{"scrypt1048576", scrypt1048576_hash, 1, 0, 0},
	...
	{"yespowerTIDE", yespowerTIDE_hash, 0x10000, 0, 0 },
	{"yespowerMGPC", yespowerMGPC_hash, 0x10000, 0, 0 },
	{"zr5", zr5_hash, 1, 0, 0},
	...
	{"argon2d250", argon2d_crds_hash, 0x10000, 0, 0 }, // Argon2d Implementation
	...
	{"argon2d16000", argon2d16000_hash, 0x10000, 0, 0 }, // Bitcreds Argon2d Implementation
